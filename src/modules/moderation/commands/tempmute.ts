...
export default class TempmuteCommand extends CustomCommand {
    name = "tempmute"
    group = "Moderation"
    permissions: Discord.PermissionString[] = ["BAN_MEMBERS"]
    description = "command_tempmute_desc"
    arguments = "command_tempmute_args"
    ...
    async run(message: Discord.Message, args: string[]) {
        ...
        await this.scheduler.scheduleUnmute(user.id, timestamp)
